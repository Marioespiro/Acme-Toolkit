...
<acme:list>
	<acme:list-column code="authenticated.inventor.toolkit.list.code" path="code" width="20%"/>
	<acme:list-column code="authenticated.inventor.toolkit.list.title" path="title" width="10%"/>
	<acme:list-column code="authenticated.inventor.toolkit.list.description" path="description" width="30%"/>
