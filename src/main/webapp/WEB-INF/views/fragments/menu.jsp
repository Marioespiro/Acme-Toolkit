...
<acme:menu-bar code="master.menu.home">
	...
	<acme:menu-right>
		...
		<acme:menu-option code="master.menu.user-account" access="isAuthenticated()">
			...
			<acme:menu-suboption code="master.menu.user-account.become-inventor" action="/authenticated/inventor/create" access="!hasRole('Patron') && !hasRole('Inventor')"/>
			<acme:menu-suboption code="master.menu.user-account.become-patron" action="/authenticated/patron/create" access="!hasRole('Patron') && !hasRole('Inventor')"/>
		</acme:menu-option>
