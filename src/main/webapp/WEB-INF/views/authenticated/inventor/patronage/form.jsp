...
<acme:form readonly="true">
	...
	<acme:input-textbox code="authenticated.inventor.patronage.form.label.name" path="name"/>	
	...
	<acme:input-textbox code="authenticated.inventor.patronage.label.link" path="link"/>
</acme:form>