...
<jstl:if test="${acme:anyOf(command, 'list-patronage')}">
	<acme:button code="authenticated.patron.patronage.list.button.create" action="/patron/patronage/create-patronage"/>
</jstl:if>	
